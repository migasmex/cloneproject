...
import 'package:spotify/widgets/custom_textfield.dart';
import 'package:spotify/widgets/loading_circle.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void register() async{
    if (passwordContoller.text == confirmPasswordContoller.text) {
      ...
      try {
        await _auth.registerEmailPassword(emailContoller.text, passwordContoller.text);
        ...
        await _db.saveUserInfoInFirebase(name: nameContoller.text, email: emailContoller.text);
